...
extern class DesktopCapture {
	static function chooseDesktopMedia( sources : Array<DesktopCaptureSourceType>, ?targetTab : Tab, callback : { streamId : String,options : { canRequestAudioTrack:Bool } }->Void ) : Void;
